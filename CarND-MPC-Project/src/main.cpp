        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    double latency = 0.1;
                    // This is the length from front to center of gravity
                    ...
                    // coordinates in vehicle's coordinate system
                    double x = 0;
                    double y = 0;
                    psi = 0;
                    
                    double psi_des = atan(polyeval(coeffs_d, x));
                    ...
                    for (int i=1; i< mpc.predx.size(); i++) {
                        mpc_x_vals.push_back(mpc.predx[i]);
                        mpc_y_vals.push_back(mpc.predy[i]);
                    }
